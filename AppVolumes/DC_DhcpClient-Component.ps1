...
Write-DiagProgress -Activity $ScriptVariable.ID_CTSDHCPClient -Status $ScriptVariable.ID_CTSDHCPClientDescription

#----------Registry
$OutputFile= $Computername + "_DhcpClient_reg_.TXT"
$CurrentVersionKeys = "HKLM\SYSTEM\CurrentControlSet\services\Dhcp"
$sectionDescription = "DHCP Client"
RegQuery -RegistryKeys $CurrentVersionKeys -Recursive $true -OutputFile $OutputFile -fileDescription "DHCP Client Registry Key" -SectionDescription $sectionDescription
...
if ($OSVersion.Build -gt 6000)
{
	...
	$sectionDescription = "DHCP Client EventLogs"
	$EventLogNames = "Microsoft-Windows-Dhcp-Client/Operational"
	$Prefix = ""
	$Suffix = "_evt_"
	.\TS_GetEvents.ps1 -EventLogNames $EventLogNames -SectionDescription $sectionDescription -Prefix $Prefix -Suffix $Suffix

	$EventLogNames = "Microsoft-Windows-DhcpNap/Operational"
	$Prefix = ""
	$Suffix = "_evt_"
	.\TS_GetEvents.ps1 -EventLogNames $EventLogNames -SectionDescription $sectionDescription -Prefix $Prefix -Suffix $Suffix

	$EventLogNames = "Microsoft-Windows-Dhcpv6-Client/Operational"
	$Prefix = ""
	$Suffix = "_evt_"
	.\TS_GetEvents.ps1 -EventLogNames $EventLogNames -SectionDescription $sectionDescription -Prefix $Prefix -Suffix $Suffix
} 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUKoJj/AeNJHaGq9j/fWEQ0hEd
# lD2gghWCMIIEwzCCA6ugAwIBAgITMwAAAEyh6E3MtHR7OwAAAAAATDANBgkqhkiG
...
# 3MK1cYGvNCoj/07Qreo4yVLJaTCBpAYKKwYBBAGCNwIBDDGBlTCBkqB4gHYARABJ
# AEEARwBfAEMAVABTAF8ARwBlAG4AZQByAGEAbABfAFIAZQBwAG8AcgB0AHMAXwBn
# AGwAbwBiAGEAbABfAEQAQwBfAEQAaABjAHAAQwBsAGkAZQBuAHQALQBDAG8AbQBw
# AG8AbgBlAG4AdAAuAHAAcwAxoRaAFGh0dHA6Ly9taWNyb3NvZnQuY29tMA0GCSqG
# SIb3DQEBAQUABIIBAA+LXSxSYPoL4HqP9PwhgJi4IRkHwF9wqUSmF+qc4GUH3ySD
# ZOxLTmpt8F48Sm5tez4qPKS+eeKbS0TcPRuKiSjUSnwHjR8QBgjBRvVnA/RKIZPs
# d9hT5Km+gP+1ttgYDzGk4kAO/8HkiWhnndN9jODJ/JocabADi/6/qWV6eBSNYDUX
# HW/FX+ZLPaUcpiwnVxUBrcD+9oMDgpCzneK2nv4oMEULaV9GBYIqyu5dvuj7eUyx
# LSg/QQIudfVMfBe8Jmw1rxqJPBkOPR3KeKzgGdXg+PZuvUiRrUD69UmvfAFrum8U
# 7inez8lInavBam4/8nyBxLAHn7DHK1FIVizCO3ahggIoMIICJAYJKoZIhvcNAQkG
...
# AQcBMBwGCSqGSIb3DQEJBTEPFw0xNDAyMjQxNzM3NTVaMCMGCSqGSIb3DQEJBDEW
# BBT2PDmD1xdxWgiEOmas0DmuorkzDjANBgkqhkiG9w0BAQUFAASCAQBvAmMAJDzh
# K9SnmeawaTvyOjS5iD9jJsK1imZZ4YM+L10Mj1wQV00wt7UieoiP1bgeBRvd54dK
# 938WD0bpzZDPeM/uj+Yu3WBuVaT/zQcft6spgdWoYTRVEtc2ArIF9dr8N0lZJntQ
# AOq9mQZWiIGqLt+x/c0C3eWoiUtLa/xeKLsqPjPSnF4ImX7PFBkT88m3i8slqwyr
# 0C4pUjx/OcAcSAFt6QqKcofBcdWCvXpfLKcP6IAf1lf4bIdubLsUFjyh/gzavdxy
# cB/ZcklFaVXaHhxWE9GZgNmnz3NFFjyNtjU8YvGiYoMkXZT5ga/WltL4T/UenNQq
# bxalY0nCa33T
